...
def my_background_task(arg1, arg2):
    '''
    Any functions that you want to run as background tasks need to be 
    decorated with the celery.task decorator.
    '''
    result = 'Hola Mundo'
    return result
...
#        pass
        ...
        print('En caso de que no sepamos que paso')
    finally:
        print('Corre pase lo que pase')
